...
description: social-carousel (Open Design)
mode: agent
---

Use the Open Design skill `od:prototype:social-carousel` (social-carousel).

Brief: ${input:brief:Design a 3-card cinematic social carousel — ‘onwards.’, ‘to the next one.’, ‘looking ahead.’. 1080×1080 squares, drop-into-Instagram ready.}
